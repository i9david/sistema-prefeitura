...
export default async function BandaApresentacoesPage({
  ...
  return (
    <ModuleLayout sidebar={<ModuloBandaMunicipalNav currentPath="/banda-municipal/apresentacoes" />}>
      <ModuleHeader
        title="Apresentações"
        eyebrow="Operação"
        description="Agenda e histórico de apresentações da Banda Municipal."
        icon={Mic}
        accent="violet"
        context="Compromissos públicos"
        action={
          !mostrarFormulario ? (
            <a href="/banda-municipal/apresentacoes?novo=1" className="btn-primary w-full justify-center md:w-auto">
